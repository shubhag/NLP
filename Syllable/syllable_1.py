...
# 				'ऩ','प','फ','ब','भ','म','य','र','ऱ','ल','ळ','ऴ','व',	\
# 				'श','ष','स','ह','क़','ख़','ग़','ज़','ड़','ढ़','फ़','य़',	\
# 				'ॠ','ॡ','ॹ','ॺ','ॻ','ॼ','ॾ','ॿ']
# full_vowels = 	['ऄ','अ','आ','इ','ई','उ','ऊ','ऋ','ऌ','ऍ','ऎ','ए',	\
# 				'ऐ','ऑ','ऒ','ओ','औ']
# merge_vowels = 	['ऀ','ँ','ं','ः','ऺ','ऻ','़','ऽ','ा','ि','ी',	\
# 				'ु','ू','ृ','ॄ','ॅ','ॆ','े','ै','ॉ','ॊ','ो',	\
# 				'ौ','्','ॎ','ॏ','॑','॒','॓','॔','ॕ','ॖ','ॗ','ॢ',	\
# 				'ॣ','॰','ॱ']
